...
Q_CONSTINIT const QMetaObject calculator::staticMetaObject = { {
    ...
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN10calculatorE_t,
        ...
        QtPrivate::TypeAndForceComplete<Button_Type, std::false_type>,
...
void calculator::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->On_clicked((*reinterpret_cast< std::add_pointer_t<Button_Type>>(_a[1])),(*reinterpret_cast< std::add_pointer_t<QString>>(_a[2]))); break;
        default: ;
        }
    }
}
